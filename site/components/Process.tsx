/**
 * Process — how engagements run (Scope → Build → Transfer).
 * Steps live in lib/content.ts (processSteps).
 */
...
export default function Process() {
  return (
    <section id="process" className="relative mx-auto max-w-6xl scroll-mt-28 px-6 pb-28">
      <GlassCard className="rounded-[36px] p-10 md:p-16">
        <SectionHeading eyebrow="Process">Clear from day one.</SectionHeading>
